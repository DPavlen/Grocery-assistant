        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[
                 core.validators.username_validator], verbose_name='Логин пользователя')),
                ('first_name', models.CharField(max_length=150, validators=[
                 core.validators.first_name_validator], verbose_name='Имя пользователя')),
                ('last_name', models.CharField(max_length=150, validators=[
                 core.validators.last_name_validator], verbose_name='Фамилия пользователя')),
                ('password', models.CharField(
                    max_length=150, verbose_name='Пароль пользователя')),
                ('role',
                 models.TextField(choices=[('user',
                                            'User'),
                                           ('moderator',
                                            'Moderator'),
                                           ('admin',
